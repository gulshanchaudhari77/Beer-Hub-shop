...
const data = [
    {
        ...
        title: "Premium Beers",
        description: "Our beers are 100% made of fresh b."
    },
    {
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-red-900 w-12 h-12 mb-3 inline-block">
