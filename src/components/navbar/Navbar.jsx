...
//         <p className="flex h-10 items-center justify-center bg-red-900 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
...
//                   <div className="flex ">
//                     <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}> <span className='text-4xl text-red-700'>B</span>eers-hub</h1>
//                   </div>
//                 </Link>
//               </div>
...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <header className="relative bg-white">
        <p
          className="flex h-10 items-center justify-center bg-red-900 px-4 text-sm font-medium text-white sm:px-6 lg:px-8"
          style={{
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className="flex">
                  <div className="flex">
                    ...
                    >
                      {' '}
                      <span className="text-4xl text-red-700">B</span>
                      eers-hub
                    </h1>
                  </div>
                </Link>
              ...
              <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-900 bg-opacity-75">
                <div className="relative bg-white w-64 h-full">
                  ...
                  <div className="flex flex-col mt-12 p-4">
                    ...
                    <a
                      className="text-sm font-medium text-gray-700 mt-4 cursor-pointer"
                      onClick={() => setOpen(false)}
                    >
                      Logout
                    </a>
